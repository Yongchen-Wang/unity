...
def start_camera_program():
    """启动摄像头检测程序"""
    print("\n" + "="*50)
    print("[3/3] 启动摄像头检测程序 (camera_tcp_magnet_anchor.py)...")
    print("="*50)
    
    camera_dir = r"D:\project\individual_project\unity\code\Mixed Reality\Sensapex\camera_image_processing"
    camera_script = "camera_tcp_magnet_anchor.py"
...
def start_data_logger():
    ...
    logger_dir = r"D:\project\individual_project\unity\code\Mixed Reality\Sensapex\camera_image_processing"
...
def main():
    ...
    if success1 and success2 and success3:
        ...
        print("  - 窗口3: 摄像头检测程序 (camera_tcp_magnet_anchor.py) - TCP客户端")
        print("\n提示:")
